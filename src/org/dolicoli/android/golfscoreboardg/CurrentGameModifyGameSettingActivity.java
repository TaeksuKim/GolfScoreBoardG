...
public class CurrentGameModifyGameSettingActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		gameSettingFragment = new ModifyGameSettingFragment();
		FragmentUtil.replaceFragment(getSupportFragmentManager(),
				R.id.GameSettingContent, gameSettingFragment);

		holeFeeSettingFragment = new ModifyHoleFeeSettingFragment();
		FragmentUtil.replaceFragment(getSupportFragmentManager(),
				R.id.HoleFeeSettingContent, holeFeeSettingFragment);

		rankingFeeSettingFragment = new ModifyRankingFeeSettingFragment();
		FragmentUtil.replaceFragment(getSupportFragmentManager(),
				R.id.RankingFeeSettingContent, rankingFeeSettingFragment);

		playerSettingFragment = new ModifyPlayerSettingFragment();
		FragmentUtil.replaceFragment(getSupportFragmentManager(),
				R.id.PlayerSettingContent, playerSettingFragment);

		handicapSettingFragment = new ModifyHandicapSettingFragment();
		FragmentUtil.replaceFragment(getSupportFragmentManager(),
